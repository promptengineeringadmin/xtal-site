...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: "No Per-Search Metering", values: [true, false, false] },
...
XTAL does not use a per-search pricing model. Contact [XTAL](/grade) for a quote. At the mid-market scale this article covers, XTAL typically underprices Klevu's merchandising tier while providing comparable or stronger AI capabilities.
