...
faqItems:
  ...
  - question: "How does XTAL's pricing compare to Algolia?"
    answer: "Algolia charges per search request and per record, which can become expensive at scale. XTAL uses a simpler pricing model based on your catalog size, making costs more predictable as your search volume grows."
...
- **Pricing model**: Algolia meters on search requests and records simultaneously — costs scale with traffic in ways that catch teams off guard. XTAL uses catalog-based pricing with no per-search charges.
...
Algolia's current pricing has four tiers. The **Build** plan is free for development and testing (1M records, 10K searches/month). The **Grow** plan is pay-as-you-go: the first 10,000 monthly searches are included, with additional searches billed at $1.75 per 1,000 and additional records at $0.40 per 1,000. **Premium** introduces AI-enhanced capabilities and moves to custom-quoted annual contracts. **Elevate** — the tier that includes NeuralSearch (semantic vector search) and Smart Groups — requires a custom enterprise agreement.

<Callout type="insight">
**Pricing example: a mid-market merchant with 500K records and 500K monthly searches.**

On Algolia Grow, the math looks like this: the 500K records break down as 400K billable extra records at $0.40/1,000 = $160/month. The 490K extra searches at $1.75/1,000 = $857.50/month. Combined base: roughly **$1,017/month** — before any AI features, which require upgrading to a custom-priced contract. If you need semantic search, budget for a meaningful step up from that.

XTAL's pricing is catalog-based with no per-search metering. For the same merchant, the cost scales with catalog size, not with how often customers search. Merchants with high search volume relative to catalog size see the most dramatic cost difference.
</Callout>
...
- **Your search volume is high relative to your catalog size.** Catalog-based pricing means high search traffic doesn't linearly increase your bill.
...
Algolia charges on two dimensions simultaneously: search requests performed and records stored. The Grow tier bills $1.75 per 1,000 additional searches and $0.40 per 1,000 additional records beyond the monthly inclusions. At mid-market volumes (500K records, 500K searches), this comes to roughly $1,000/month before any AI features. XTAL uses catalog-size-based pricing with no per-search metering, which makes costs significantly more predictable for stores with high search traffic relative to catalog size.
