...
const SOCIAL_LINKS = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/promptengineeringinc",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mb-5">
              Get AI search insights and product updates delivered to your inbox.
            </p>
            <FooterSubscribe />
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mb-5">
              Conversations on AI, e-commerce, and the future of search.
            </p>
            <a
        ...
        <div className="border-t border-slate-700 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-slate-500">
            &copy; Prompt Engineering, Inc {new Date().getFullYear()}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
