        ...
        <form onSubmit={handleSubmit} className="relative max-w-3xl mx-auto group">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 ring-1 ring-slate-900/5 flex items-center p-2 pl-6">
            ...
            <input
              ...
              placeholder="Describe what you're looking for... e.g., 'a reliable coffee grinder for espresso'"
              className="w-full bg-transparent border-0 focus:ring-0 text-lg py-4 px-4 text-slate-900 placeholder:text-slate-400 focus:outline-none"
            />
            <button
              type="submit"
              disabled={loading || !value.trim()}
              className="bg-slate-900 text-white px-8 py-4 rounded-xl font-medium hover:bg-indigo-600
